    ...
    <PageShell>
              ...
              <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-ink to-black text-white p-6 sm:p-9 glass-outline-subtle">
                ...
                <div className="space-y-3 text-white/90 relative">
                  <p className="flex items-start gap-2">
                    ...
                    <span>Office Suite F10, Newcom Business Centre,<br />125 Poplar High Street, London E14 0AE</span>
                  </p>
              ...
              <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-crimson to-[#520a09] text-white p-6 sm:p-9 glass-outline-subtle">
                ...
                <div className="mt-6 pt-5 border-t border-white/20 relative">
                  ...
                  <div className="flex items-center gap-3">
                    <a href="https://www.linkedin.com/company/prositeuk/" target="_blank" aria-label="LinkedIn" className="h-9 w-9 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors">
                    ...
                    <a href="https://www.instagram.com/_prositeuk/" target="_blank" aria-label="Instagram" className="h-9 w-9 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors">
                      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <a href="https://www.facebook.com/people/Prositeuk/61571225233602/" target="_blank" aria-label="Facebook" className="h-9 w-9 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors">
                      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <section className="bg-gradient-to-br from-[#efefef] via-white to-white py-12 sm:py-14 rounded-xl glass-outline-subtle">
        <div className="px-5 sm:px-7">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold mb-2">Looking for work?</h2>
